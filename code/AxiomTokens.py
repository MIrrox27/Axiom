...
class AxiomTokenType(Enum):
    ...
    FUNCTION = 'FUNCTION' # Особый тип данных для использования в словарях и списках (понадобится в будущем)
    ...
    NILL = 'NILL' # Ключевое слово nill (мб, сделаем так, чтобы можно было заменить на ";;")
